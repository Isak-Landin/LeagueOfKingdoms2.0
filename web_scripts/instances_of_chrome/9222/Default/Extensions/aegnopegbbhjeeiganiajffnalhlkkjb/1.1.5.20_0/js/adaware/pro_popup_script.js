            ...
            chrome.runtime.sendMessage({
                ...
                if (data.hasPermission === false && BrowserFamily != "Edge") {
                    if (openPermissionPanelCounter < 2) {
                        ...
                        permissionPanel.style.cssText = "all: unset; display: block; position: fixed; top: 16px; right: 389px; width: auto; height: auto; background-color: #fff; z-index: 99999996;";

                        var containerPermission = document.createElement('div');
                        containerPermission.setAttribute("id", "sts_container");
                        containerPermission.style.cssText = "display: block; position: ralative; width: 258px; height: 524px; padding: 45px 47px; border: solid 1px #e6e6e6; border-radius: 1px; text-align: center;";
